...
export function NotificheBell({ unreadCount = 0 }: { unreadCount?: number }) {
  return (
    <Link
      ...
      className="hide-on-sheet fixed right-3 z-30 inline-flex h-11 w-11 min-h-[44px] min-w-[44px] items-center justify-center rounded-full border border-border bg-background/90 text-foreground shadow-soft backdrop-blur active:scale-95 transition-transform"
