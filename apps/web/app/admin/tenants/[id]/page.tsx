...
const CONFIG_KANTIERE_LABELS: [string, string][] = [
  ['soglia_ore_ordinarie', 'Orario ordinario giornaliero (h)'],
  ['quote_ore_dal', 'Viaggio nell\'orario ordinario dal'],
  ['arrotondamento_viaggio_min', 'Arrotondamento viaggio (min)'],
  ['arrotondamento_ore_min', 'Arrotondamento ore di lavoro (min)'],
  ['avvio_turno_libero', 'Avvio turno su ogni cantiere'],
  ['split_fine_turno_attivo', 'Ripartizione ore alla chiusura'],
  ['registra_giornata_attivo', 'Registra giornata'],
  ['tolleranza_chiusura_min', 'Tolleranza ripartizione (min)'],
  ['passo_minuti_stepper', 'Passo tasti + e − (min)'],
  ['soglia_pausa_pranzo_ore', 'Promemoria pausa pranzo (h)'],
  ['soglia_auto_spegnimento_pausa_ore', 'Chiusura automatica pausa (h)'],
  ['km_solo_autista', 'Km solo a chi guida'],
  ['auto_approva_rapportini', 'Approvazione automatica giornate'],
  ['anomalia_turno_ore_max', 'Soglia di verifica giornata (h)'],
