...
import { MoreHorizontal, ShieldCheck, UserMinus, UserPlus2 } from 'lucide-react';
import {
  cambiaRuolo,
  disattivaUtente,
  riattivaUtente,
            ...
            {utenti.map((u) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="codice text-xs text-muted-foreground md:col-span-2">
                          ...
                          {u.attivo ? (
                            <DropdownMenuItem
                              ...
                              onSelect={() => {
                                if (
                                  !confirm(
                                    `Disattivare ${u.display_name ?? u.email}?`,
                                  )
                                )
                                  return;
                                start(async () => {
