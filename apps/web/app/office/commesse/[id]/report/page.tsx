...
/**
 * Report di chiusura commessa — pagina print-ready (A4 verticale).
 *
 * Layout:
 *   1. Header brandizzato (logo tenant + brand line gradient blu→arancio)
 *   2. Sezione Commessa (codice, cliente, indirizzo, responsabile, data, stato)
 *   3. Riepilogo fasi (tabella voce/stato/foto/note)
 *   4. Galleria foto (3 col, signed URL su file_refs finali / in_corso)
 *   5. Documenti DICO + Certificazioni (signed URL)
 *   6. Footer + firma cliente
 *
 * Tutto il fetch è in parallelo via Promise.all.
 */
export default async function ReportPage({
  ...
  // Costruisci provider storage (può fallire se config incompleta → galleria vuota)
  ...
  // Signed URLs in parallelo (10 min)
  ...
  return (
    <>
      {/* CSS scoped al report — print-friendly. Inline così rimane locale alla pagina. */}
      <style
        // eslint-disable-next-line react/no-danger
        dangerouslySetInnerHTML={{
          __html: `
            .report-page { background: #fff; color: #0a0a0a; }
            .report-page .page-shell { max-width: 210mm; margin: 0 auto; padding: 12mm 14mm; }
            ...
            .report-page h1, .report-page h2 { letter-spacing: -0.02em; }
            ...
            .report-page .photo-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; }
            ...
            .report-page .header-grid .logo-wrap { width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; }
            .report-page .header-grid .logo-wrap img { max-width: 100%; max-height: 100%; object-fit: contain; }
            .report-page .meta-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 6px 16px; font-size: 11pt; }
            .report-page .meta-grid dt { font-size: 9pt; text-transform: uppercase; letter-spacing: 0.04em; color: #64748b; }
            .report-page .meta-grid dd { margin: 0 0 8px; font-weight: 500; }

            @media screen {
              body { background: #f1f5f9; }
              .report-page { padding: 24px 0; }
            }
            @media print {
              /* Nasconde tutta la chrome dell'office shell (sidebar, topbar,
                 breadcrumbs, command palette) e mostra solo il report */
              ...
              .report-page .page-shell { padding: 0; max-width: none; }
        ...
        <div className="page-shell">
          ...
          <div className="no-print mb-6 flex items-center justify-between gap-3">
            <p className="text-xs text-muted-foreground">
              Anteprima report di chiusura · Stampa o salva come PDF dal browser.
            </p>
            <PrintButton />
          </div>
          ...
          <div className="header-grid">
            ...
            <div className="logo-wrap">
              {tenant?.logo_url ? (
                ...
                <div
                  className="flex h-full w-full items-center justify-center rounded-md text-[18pt] font-bold text-white"
          ...
          {/* 5. Documenti DICO + Certificazioni */}
          <section className="section">
            <h2 className="mb-3 text-[14pt] font-semibold" style={{ color: '#0f172a' }}>
