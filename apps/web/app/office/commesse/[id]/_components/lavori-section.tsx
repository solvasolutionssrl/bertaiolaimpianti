 ...
 *
 * Tutto il caricamento avviene qui (server): il client riceve dati
 * materializzati. Usata sia dalla tab Commessa (hub operativo) sia dalla
 * route legacy /lavori (wrapper per back-compat dei deep link).
 */
export async function LavoriSection({ id }: { id: string }) {
