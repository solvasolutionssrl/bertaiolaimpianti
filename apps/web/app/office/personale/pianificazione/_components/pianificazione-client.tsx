      ...
      <DialogContent className="max-h-[92vh] w-full max-w-[calc(100vw-1rem)] overflow-y-auto overflow-x-hidden sm:max-w-[1160px]">
        ...
        <div className="min-w-0 space-y-3">
          <div className="grid min-w-0 grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
            ...
            {/* DESTRA (1/3): dipendenti, full-height, separata */}
            <div className="min-w-0">
              <div className="flex h-full min-h-[22rem] flex-col rounded-lg border border-emerald-200 bg-emerald-50/40 p-3">
                ...
                <div className="min-h-0 flex-1 space-y-0.5 overflow-y-auto rounded-md border border-border bg-white p-1">
                  {dipFiltrati.map((d) => {
