...
- **15/09/2026, prove da telefono**: si indica solo l'ora di inizio (fine = inizio + ore + pausa + tratte, con il conto a vista), chi guidava per tratta, pausa pranzo arancione, card «La giornata» più bassa.
