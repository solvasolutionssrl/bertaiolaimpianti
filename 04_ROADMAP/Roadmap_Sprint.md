...
| Task | Output |
|---|---|
| Acquisto domini (`cantiera.app`, sub `m.cantiera.app` per PWA, `bertaiolaimpianti.<dominio_app>`, etc.) | DNS attivi su Cloudflare |
...
- ✅ `app.cantiera.app/bertaiola` accessibile da 5 PC ufficio
- ✅ `m.cantiera.app/bertaiola` installabile su 15 iPhone via "Aggiungi alla schermata Home"
...
| Pulsante "Richiedi intervento" → crea ticket nativo in automatico (Cantiera, niente Freshdesk) |
