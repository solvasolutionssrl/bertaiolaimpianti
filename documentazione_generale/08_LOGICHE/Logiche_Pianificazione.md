...
> **Mezzi e note sul foglio (dal 20/09/2026)**: prima il PDF non li stampava affatto, pur essendo compilati — su FPM **ogni** blocco ha un mezzo assegnato. Ora sotto il codice commessa compare **«Mezzo FP418XX · Ford Transit Connect»** (targa **e** nome: la targa è l'unica cosa univoca, in flotta ci sono tre «Ford Transit Connect», ma il nome è come il mezzo lo chiamano davvero; con più mezzi, **uno per riga**) e sotto ancora **la nota in corsivo, per intero e mai tagliata**: è un'istruzione per chi va in cantiere, non un promemoria interno.
...
> **Il foglio è l'unico canale**: l'ufficio esporta il PDF e lo manda ai ragazzi **su WhatsApp** (l'app mobile non è in uso, i blocchi restano tutti in bozza). Per questo la nota ha un corpo suo, un filo più grande del resto: si legge da telefono. E per questo il mezzo per esteso costa una riga in più per casella — il foglio passa da circa **10 a circa 8 persone per pagina**. Se un giorno diventasse un problema, la strada è l'**A4 orizzontale** (colonne da ~50 mm: il mezzo tornerebbe su una riga sola), non tagliare le informazioni.
