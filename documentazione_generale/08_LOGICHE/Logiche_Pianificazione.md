...
- **Anteprima a forma di card**: durante resize/sposta, in ogni cella bersaglio (tutte le righe dei membri) compare una **striscia** dello stesso colore/altezza del chip (dashed, pulsante) → sembra che la card si allunghi/si sposti. Niente riquadro pieno di cella.
