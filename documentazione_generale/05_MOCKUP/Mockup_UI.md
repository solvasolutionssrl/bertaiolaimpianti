# Mockup UI — impiantiXplus (SOLVA × Bertaiola)
**Versione**: 1.0
...
**Stile**: tono fresco/tecnico, palette impiantiXplus (Ocra `#D97706` + Blu `#1E40AF` + neutri).
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ [logo Bertaiola]  impiantiXplus                         🔔  👤 Mario Rossi▾ │
├──────────┬──────────────────────────────────────────────────────────────────┤
│          │                                                                  │
...
Header brand: **logo Bertaiola** (caricato per tenant) + scritta "impiantiXplus" + footer discreto "powered by SOLVA". Sidebar a sinistra collassabile.
